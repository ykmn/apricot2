...
- Кнопка **↑** — добавить элемент плейлога в список выбранных фрагментов. Однако имейте в виду, что реальное время записи звука может отличаться от времени отражённого в плейлоге до нескольких секунд.
